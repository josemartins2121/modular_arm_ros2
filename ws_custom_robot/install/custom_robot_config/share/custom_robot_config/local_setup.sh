...
: ${AMENT_CURRENT_PREFIX:="/root/modular_arm_ros2/ws_custom_robot/install/custom_robot_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_robot_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_robot_config/environment/path.sh"
